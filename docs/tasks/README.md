...
- [x] [M1-08](M1-08-settings-shell-and-capture-pane.md) — Settings window plus the Capture pane — PR #20
...
- [x] [M2.5-05](M2.5-05-auto-export.md) — auto-export, defaulting ON — PR #32
...
- [x] [M3-02](M3-02-anthropic-provider.md) — Anthropic provider with a runtime-fetched model list — PR #35
- [x] [M3-03](M3-03-summarization-call.md) — both output schemas, prompt constraints, degradation path — PR #37
- [x] [M3-04](M3-04-ai-settings-ui.md) — provider, key, model picker, Test connection — PR #38
