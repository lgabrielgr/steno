...
public func plan(_ data: Data) throws -> ImportPlan {
    ...
    // Both sides normalized. Taking the file's precision on trust is wrong:
    // the decoder accepts more than three fractional digits, and §10.2 invites
    // hand-editing.
...
private func applyEvents(_ records: [ExportedEvent]) throws {
    ...
    for record in records {
        ...
        // stand-up. Caught by `ImportApplyScopeTests`.
...
| Tests | `make test` | `Test Execute Succeeded`, 503 passing |
